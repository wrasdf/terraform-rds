...
variable "environment" {
  description = "Environment syntax."
  type        = string
}
...
variable "allow_sg_ids" {
  description = "List of security group ids to allow in ingress."
  type        = list(string)
  default     = []
}
...
variable "db_users" {
  description = "List of db users to access RDS using IAM."
  type        = list(string)
  default     = []
}

variable "iam_auth_roles" {
  description = "List of IAM roles to attach the db user access IAM policy."
  type        = list(string)
  default     = []
}
